...
python -c "convNonLin = 'identity'; FCnonLin = 'relu'; print('convNonLin: %s, FCnonLin: %s' % (convNonLin, FCnonLin)); import  cifar10_train as model; model.main(convNonLin, FCnonLin);import cifar10_eval as eval; eval.main(convNonLin, FCnonLin)" 2>&1  | tee /results/log.txt
python -c "convNonLin = 'relu'; FCnonLin = 'relu'; print('convNonLin: %s, FCnonLin: %s' % (convNonLin, FCnonLin)); import  cifar10_train as model; model.main(convNonLin, FCnonLin);import cifar10_eval as eval; eval.main(convNonLin, FCnonLin)" 2>&1  | tee /results/log2.txt
